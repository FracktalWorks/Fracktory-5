...
| Material XML profiles | `resources/materials/Fracktal Works/*.xml.fdm_material` |
...
|------|---------|---------|-------|
| T0   | -20     | -10     | Left of bed, at Y position_min (front edge) |
| T1   | 620     | -10     | Right of bed, at Y position_min (front edge) |
...
|-------|----------|-----------|----------|-------------|
| 1     | 20mm     | 50mm      | 300mm/m  | Slow prime  |
| 2     | 20mm     | 50mm      | 500mm/m  | Medium purge|
| 3     | 20mm     | 60mm      | 800mm/m  | Fast purge  |
| 4     | 20mm     | 60mm      | 1000mm/m | Full speed  |
| **Total** | **80mm** | **220mm** | — | Per tool |
