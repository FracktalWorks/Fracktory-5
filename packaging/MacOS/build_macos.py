...
def build_pkg(dist_path: str, app_filename: str, component_filename: str, cura_version: str, installer_filename: str) -> None:
    ...
    # This builds the component package that contains AddiSlice.app. This component package will be bundled in a distribution package.
    pkg_build_arguments = [
    ...
    installer_creation_arguments = [
        ...
        "--package-path", dist_path,  # Where to find the component packages mentioned in distribution.xml (AddiSlice.pkg)
...
def create_pkg_installer(filename: str,  dist_path: str, cura_version: str, app_name: str) -> None:
    ...
    The final package structure is AddiSlice-XXX-Installer.pkg[AddiSlice.pkg[AddiSlice.app]]. The outer
    ...
    cura_component_package_name = f"{filename_stem}-Component.pkg"  # This is a component package that is nested inside the installer, it contains the AddiSlice.app file This is the app file that will end up in your applications folder
...
def create_dmg(filename: str, dist_path: str, source_path: str, app_name: str) -> None:
    """ Creates a dmg executable from AddiSlice.app named {filename}.dmg
...
if __name__ == "__main__":
    ...
    parser.add_argument("--filename", required = True, type = str, help = "Filename of the pkg/dmg (e.g. 'AddiSlice-5.5.0-Macos-X64' or 'AddiSlice-5.5.0-beta.1-Macos-ARM64')")
