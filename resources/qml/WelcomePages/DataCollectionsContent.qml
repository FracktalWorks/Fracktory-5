...
//
// This component contains the content for the "Help us to improve AddiSlice" page of the welcome on-boarding process.
...
Item
{
    UM.Label
    {
        ...
        text: "Help us to improve AddiSlice"
    ...
    Item
    {
        ...
        Column
        {
            ...
            UM.Label
            {
                ...
                anchors.horizontalCenter: parent.horizontalCenter
                horizontalAlignment: Text.AlignHCenter
                text: "AddiSlice collects anonymous data to improve print quality and user experience, including:"
            ...
            UM.Label
            {
                ...
                text:
                {
                    var t = "Data collected by AddiSlice will not contain any personal information."
