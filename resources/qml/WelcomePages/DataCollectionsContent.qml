...
Item
{
    UM.Label
    {
        ...
        text: "Help us to improve Fracktory"
    ...
    Item
    {
        ...
        Column
        {
            ...
            UM.Label
            {
                ...
                anchors.horizontalCenter: parent.horizontalCenter
                horizontalAlignment: Text.AlignHCenter
                text: "Fracktory collects anonymous data to improve print quality and user experience, including:"
            ...
            UM.Label
            {
                ...
                text:
                {
                    var t = "Data collected by Fracktory will not contain any personal information."
