...
class CrashHandler:
    ...
    def _createEarlyCrashDialog(self):
        ...
        label = QLabel()
        label.setText(catalog.i18nc("@label crash message", """<p><b>Oops, AddiSlice has encountered something that doesn't seem right.</p></b>
    ...
    def _messageWidget(self):
        label = QLabel()
        label.setText(catalog.i18nc("@label crash message", """<p><b>A fatal error has occurred in AddiSlice. Please send us this Crash Report to fix the problem</p></b>
