...
A continuation of [Spoon Anti-Warping](https://github.com/5axes/SpoonAntiWarping/) by [5axes](https://github.com/5axes/), now renamed to AntiWarpingTabs.
...
## So how do I use it?
Glad you asked! Just select your object, then click the icon on the toolbar for the AntiWarpingTabs tool:

It looks like this --> ![Toolbar icon for AntiWarpingTabs](/images/toolbar_icon.webp)
