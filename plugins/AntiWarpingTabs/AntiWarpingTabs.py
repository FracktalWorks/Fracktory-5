#--------------------------------------------------------------------------------------------------------------------------------------
# AntiWarpingTabs by Slashee the Cow
...
#--------------------------------------------------------------------------------------------------------------------------------------
# Version history (AntiWarpingTabs version)
# v1.1.3:
...
if catalog.hasTranslationLoaded():
    log("i", "AntiWarpingTabs translation loaded")

class AntiWarpingTabs(Tool):
    def __init__(self) -> None:
        ...
        self._default_message_title = catalog.i18nc("@message:title", "AntiWarpingTabs")
        ...
        self._preferences.addPreference("spoonawreborn/teardrop_shape", True)
    ...
    def _run_spoon_order(self, output_device) -> None:
        log("i", f"AntiWarpingTabs: _run_spoon_order running with _print_order of {self._print_order}")
