...
class CuraEngineBackend(QObject, Backend):
    ...
    def __init__(self) -> None:
        ...
        self._slicing_error_message.addAction(
            ...
            description = catalog.i18nc("@message:description", "Report a bug on AddiSlice's issue tracker."),
            icon = "[no_icon]"
        )
    ...
    def _reportBackendError(self, _message_id: str, _action_id: str) -> None:
        ...
        """
        QDesktopServices.openUrl(QUrl("https://github.com/FracktalWorks/AddiSlice/issues/new/choose"))
